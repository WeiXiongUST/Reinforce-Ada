...
def load_hf_lm_and_tokenizer(
    ...
    tokenizer = AutoTokenizer.from_pretrained(
        tokenizer_name_or_path, use_fast=use_fast_tokenizer, padding_side=padding_side, trust_remote_code=True
    )
    ...
    if tokenizer.pad_token is None:
        if tokenizer.unk_token:
            ...
            raise ValueError("You are using a new tokenizer without a pad token.This is not supported by this script.")
